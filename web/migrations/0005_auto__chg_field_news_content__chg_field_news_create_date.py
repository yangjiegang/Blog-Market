...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('web_news', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2016, 5, 31, 0, 0)))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'News.create_date'
        db.alter_column('web_news', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
